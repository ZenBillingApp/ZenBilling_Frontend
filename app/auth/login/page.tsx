    ...
    return (
        <div className="flex w-full">
            <div className="w-1/2 relative">
                <Image
                    src="/assets/images/cell_background.svg"
            ...
            <div
                className={cn(
                    "flex flex-col justify-center items-center min-h-screen w-1/2 gap-4 overflow-auto bg-background"
                )}
            >
                <div className="flex-col justify-start w-3/4">
                    <div className="flex flex-col gap-3">
                        <h1
                            className={cn(
                                "text-6xl font-Caveat text-center text-primary"
                            )}
                        >
                            Welcome back !
                        </h1>
