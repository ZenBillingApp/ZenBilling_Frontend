...
export default NiceModal.create(({ customer }: EditCustomerDialogProps) => {
  ...
  const { register, handleSubmit, formState: { errors }, reset, setValue } = useForm<FormData>({
    ...
    defaultValues: {
      ...
      business: customer.type === 'company' ? {
          ...
          <div className="px-6 pb-6">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              {customer.type === 'individual' ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Switch id="tva_applicable" {...register('business.tva_applicable')} defaultChecked={customer.BusinessCustomer?.tva_applicable || false} onCheckedChange={(checked) => setValue('business.tva_applicable', checked)} />
              ...
              <div className="flex justify-end space-x-2">
                <Button variant="outline" type="button" onClick={handleClose} disabled={updateCustomerMutation.isPending}>
                  Annuler
                </Button>
