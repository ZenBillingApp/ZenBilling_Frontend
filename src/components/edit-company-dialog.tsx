...
const CompanyEditor: React.FC<Props> = ({ company, onSave, trigger }) => {
      ...
      <CredenzaContent>
        <ScrollArea className="flex w-full max-h-[80vh] overflow-y-auto">
          <div className="flex flex-col w-full gap-4 p-2">
            ...
            <CredenzaDescription>
              <p>
                Les informations de votre entreprise sont utilisées pour générer
                des documents tels que les factures et les devis.
              </p>
            </CredenzaDescription>
