                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-4">
                        <Button type="submit" className="w-full" disabled={isLoadingLogin}>
                            {isLoadingLogin ? <Loader2 className="w-4 h-4 mr-2 animate-spin" /> : null}
                            {isLoadingLogin ? "Connexion en cours..." : "Se connecter"}
                        </Button>
                        ...
                        >
                            ...
                            {isLoadingGoogle ? "Connexion en cours..." : "Connexion avec Google"}
                        </Button>
                    </div>
                </form>
            </Form>
