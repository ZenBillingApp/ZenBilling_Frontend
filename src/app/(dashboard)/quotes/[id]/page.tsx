                        ...
                        {quoteData.data?.status === 'sent' && (
                            <>
                                <Button variant="outline" onClick={() => handleUpdateStatus('accepted')} className="flex-1 sm:flex-none">
                                    ...
                                    <span className="hidden sm:inline">Marquer comme accepté</span>
                                </Button>
                    ...
                    <CardContent className="pt-6">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full">
                                <Badge variant={getStatusBadgeVariant(quoteData.data?.status)} className="px-4 py-1.5 text-sm w-fit">
                            ...
                            <div className="text-right w-full sm:w-auto">
                                ...
                                <p className="text-2xl font-bold tabular-nums">{formatCurrency(quoteData.data?.amount_including_tax)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent>
                            ...
                            <div className="inline-block min-w-full align-middle px-6">
                                <div className="overflow-hidden">
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                                                <TableHead className="w-[40%] font-medium">Produit</TableHead>
                                                <TableHead className="hidden sm:table-cell font-medium">Prix unitaire HT</TableHead>
                                                <TableHead className="hidden sm:table-cell font-medium">TVA</TableHead>
                                                <TableHead className="font-medium">Quantité</TableHead>
                                                <TableHead className="hidden sm:table-cell font-medium">Unité</TableHead>
                                                <TableHead className="hidden lg:table-cell font-medium">Total HT</TableHead>
                                            ...
                                            {quoteData.data?.QuoteItems?.map((item: IQuoteItem) => {
                                                ...
                                                return (
                                                    <TableRow key={item.item_id}>
                                                        ...
                                                        <TableCell className="hidden sm:table-cell tabular-nums">{formatCurrency(item.unit_price_excluding_tax)}</TableCell>
                                                        ...
                                                        <TableCell className="hidden lg:table-cell tabular-nums">{formatCurrency(totalHT)}</TableCell>
                                                        <TableCell className="tabular-nums">{formatCurrency(totalTTC)}</TableCell>
                                                    </TableRow>
                                                )
                                            })}
                                        </TableBody>
                        ...
                        <div className="mt-6 space-y-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="font-medium tabular-nums">{formatCurrency(quoteData.data?.amount_excluding_tax)}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-muted-foreground">TVA</span>
                                <span className="font-medium tabular-nums">{formatCurrency(quoteData.data?.tax)}</span>
                            </div>
                            <Separator />
                            <div className="flex justify-between font-medium">
                                <span>Total TTC</span>
                                <span className="tabular-nums">{formatCurrency(quoteData.data?.amount_including_tax)}</span>
                            </div>
                        </div>
                    </CardContent>
                </Card>
