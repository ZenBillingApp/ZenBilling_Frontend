      ...
      <div className="grid gap-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium">
                      {selectedCustomer.type === "company"
                        ? selectedCustomer.business?.name
                        : `${selectedCustomer.individual?.first_name} ${selectedCustomer.individual?.last_name}`}
                    </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sélectionnez la date de facturation et d&apos;échéance
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <DatePicker
                  date={invoiceDate}
                  setDate={(date) =>
                    date && setInvoiceDate(new Date(format(date, "yyyy-MM-dd")))
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <DatePicker
                  date={dueDate}
                  setDate={(date) =>
                    date && setDueDate(new Date(format(date, "yyyy-MM-dd")))
                  }
                />
              </div>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Ajoutez des conditions et pénalités de retard
            </CardDescription>
          </CardHeader>
