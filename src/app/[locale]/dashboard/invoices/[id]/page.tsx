    ...
    <div className="flex flex-col flex-1 gap-6">
        ...
        <Card className="relative flex flex-col w-full gap-2 p-6">
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent className="p-10">
              <SheetHeader>
                <SheetTitle>
                  <h1 className="text-2xl font-semibold">Select a customer</h1>
                </SheetTitle>
                <SheetDescription>
                  <Input
        ...
        {editOpen ? (
          <>
            ...
            <div className="flex gap-4 mt-4 justify-end">
              ...
              <Button className="flex gap-1" onClick={handleSaveItems}>
                <Save size={20} />
                Save Items
              </Button>
            </div>
      ...
      <div className="flex justify-end p-4">
        <div className="w-full md:w-1/4">
          ...
          <div className="flex justify-between">
            <h2 className="text-sm font-semibold">VAT Amount</h2>
            <p className="flex w-24 text-sm items-start text-right">
              ${(totalAmount - totalAmountWithoutVAT).toFixed(2)}
            </p>
          </div>
          <div className="flex justify-between">
